...
public class HttpSession {
  ...
  public HttpSession(ApplicationManager app){
    this.app = app;
    httpClient = HttpClients.custom().setRedirectStrategy(new LaxRedirectStrategy()).build(); //создаем новый клиент, новую сессию для работы
  }
  ...
  public boolean isLogginAs (String username) throws IOException {
